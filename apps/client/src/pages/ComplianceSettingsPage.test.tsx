...
/**
 * Manager settings-form tests: the form seeds from GET, a valid change PUTs the full band,
 * and an out-of-order change (amber > green) is blocked client-side by the shared schema
 * refine before any network call.
 */
...
function renderPage() {
  ...
  return render(
    <QueryClientProvider client={client}>
      <MemoryRouter initialEntries={['/compliance-settings']}>
